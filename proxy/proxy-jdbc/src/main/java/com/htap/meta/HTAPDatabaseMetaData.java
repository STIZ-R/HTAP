...
public class HTAPDatabaseMetaData implements DatabaseMetaData {
    ...
    private final HTAPConnection conn;

    public HTAPDatabaseMetaData(HTAPConnection conn) {
        this.conn = conn;
    }
    ...
    // Les autres méthodes peuvent être stubs ou retourner SQLFeatureNotSupportedException
    ...
    @Override
    public String getDriverVersion() { return "1.0"; }
